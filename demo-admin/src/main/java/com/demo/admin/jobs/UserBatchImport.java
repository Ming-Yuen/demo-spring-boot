...
public class UserBatchImport {
    ...
    private LoggingItemReadListener<Users> loggingItemReadListener;
...
//            }});
    ...
    @Bean
    public ItemWriter<Users> writer() {
        return users->userService.updateUser(new ArrayList<>(users.getItems()));
    }

    @Bean
    public Step insertToPending(final JobRepository jobRepository, final PlatformTransactionManager transactionManager, ItemReader<Users> reader, ItemWriter<Users> writer, UserItemProcessor processor) {
        return new StepBuilder("step1", jobRepository)
                .<Users, Users>chunk(10000, transactionManager)
                .reader(reader)
                .processor(processor)
                .writer(writer)
//                .taskExecutor(taskExecutor())
    ...
    public static class UserItemProcessor implements ItemProcessor<Users, Users> {
        ...
        public Users process(Users Users) throws Exception {
            ...
            return Users;
//            Users old_userPending = map.get(user.getUserName());
...
//            return null;
    ...
    public class UserFieldSetMapper implements FieldSetMapper<Users> {
        @Override
        public Users mapFieldSet(FieldSet fieldSet) {
            Users Users = new Users();
            Users.setUserName(fieldSet.readString("username"));
            Users.setFirstName(fieldSet.readString("firstName"));
            Users.setLastName(fieldSet.readString("lastName"));
            Users.setUserPassword(fieldSet.readString("password"));
            Users.setEmail(fieldSet.readString("email"));
            Users.setGender(fieldSet.readString("gender"));
            Users.setPrivilege(UserConstant.PRIVILEGE_USER);
            return Users;
        }
    }
